import { UIViewPublicServiceListItemOptionsProps } from './list-item';

export function UIViewPublicServiceListItemSkeleton(
  props: UIViewPublicServiceListItemOptionsProps
) {
  return (
