...
export type UIViewNewsCarouselHeadlineType = IUICreateCustomizableDefine<
  {
    items: any[];
  },
  {
    carousel: Partial<UICarouselType['props']['customizes']>;
  }
>;
export const UIViewNewsCarouselHeadline: UIViewNewsCarouselHeadlineType['returnType'] =
  (props) =>
    UICreateCustomizable<UIViewNewsCarouselHeadlineType>({
      props,
      defaults: {
        carousel: () => ({}),
      },
        ...
        return (
          <UICarousel
            ...
            customizes={{
              ...render('carousel'),
              ContentComponent: () => {
                return ({ item, items, setCurrentIndex, currentIndex }) => {
