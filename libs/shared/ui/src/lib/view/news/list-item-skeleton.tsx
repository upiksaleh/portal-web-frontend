...
import { UIViewNewsListItemOptionsProps } from './list-item';

export type UIViewNewsListItemSkeletonProps = UIViewNewsListItemOptionsProps;

export function UIViewNewsListItemSkeleton({
  view = 'grid',
  small,
}: UIViewNewsListItemSkeletonProps) {
  return (
    <article
      className={clsx(
