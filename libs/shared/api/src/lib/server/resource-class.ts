...
export abstract class BaseResourceClass<
  C extends keyof DirectusItemsListType,
  I extends Item = TypeOf<DirectusItemsListType, C>
> {
  ...
  protected apiResourceFetchConfig: {
    query?: QueryMany<I>;
    normalizer?: (data) => any;
  } = {};
   ...
   * @param options
   */
  async fetchCustomQuery<Q extends QueryMany<I>>(
    query?: Q,
    options?: ItemsOptions
  ): Promise<ManyItems<I, Q>> {
